...
SELECT
    ...
    CASE WHEN Vendor.[Country_Region Code] = 'HK' THEN 'CN' ELSE Vendor.[Country_Region Code] END
                                        AS vendor_country,
    ...
    ReceiptTable.posting_date          AS posting_date,
    ...
    -- actual lead time in days (NULL if not yet received)
    DATEDIFF(
      day,
      HeaderData.[Order Date],
